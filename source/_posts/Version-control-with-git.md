...
It is a system that records and stores every change made to the project thereby allowing us to go back to a previous state at any time. With a good version control system you get the below features for a very little overhead.
